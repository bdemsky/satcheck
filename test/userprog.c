...
int user_main(int argc, char **argv)
{
	...
	MCID mlgr1=MC2_nextOpLoad(MCID_NODEP);
	int lgr1=load_32(&gr1);

	MCID mlgr2=MC2_nextOpLoad(MCID_NODEP);
	int lgr2=load_32(&gr2);
	printf("lrg1=%d lrg2=%d\n", lgr1, lgr2);
	MCID br1,br2;
	if (lgr1==42) {
		br1=MC2_branchUsesID(mlgr1, 1, 2, true);
		if (lgr2==42) {
			br2=MC2_branchUsesID(mlgr2, 1, 2, true);
		} else {
			br2=MC2_branchUsesID(mlgr2, 0, 2, true);
		}
		MC2_merge(br2);
	} else {
		br1=MC2_branchUsesID(mlgr1, 0, 2, true);
	}
	MC2_merge(br1);
